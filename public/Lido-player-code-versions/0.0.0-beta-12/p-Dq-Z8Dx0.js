...
var n,
  ...
  w = [],
  x = (t, e) => (o) => {
    (t.push(o), v || ((v = !0), e && 4 & h.u ? S($) : h.raf($)));
  },
  k = (t) => {
  ...
  $ = () => {
    (k(y), k(w), (v = y.length > 0) && h.raf($));
  },
  S = (t) => m().then(t),
  j = x(w, !0),
  O = (t) => {
    const e = new URL(t, h.p);
...
var R,
          ...
          ((n = e[o]),
            Array.isArray(n)
              ...
              : null != n &&
                ...
                s && r ? (a[a.length - 1].m += n) : a.push(s ? U(null, n) : n),
                (r = s)));
      };
    if ((c(o), e)) {
  ...
  I = (t) => {
    ...
    const n = {};
    for (const o of e)
      n[o] = t[o].map((t) => ('string' == typeof t ? { [t]: 0 } : t));
    return n;
  },
  W = (t, e) =>
    null == t || D(t)
  ...
  V = (t, e) => {
    ...
    return {
      emit: (t) =>
        q(o, e, { bubbles: !0, composed: !0, cancelable: !0, detail: t }),
    };
  },
  q = (t, e, o) => {
    const n = h.ce(e, o);
  ...
  G = (t, e, o, n, i, s) => {
    ...
    if ('class' === e) {
      ...
      ((e = e.replace(Q, '')), o && h.rel(t, e, o, i), n && h.ael(t, e, n, i));
    }
  },
  Z = /\s/,
  J = (t) => (
    'object' == typeof t && t && 'baseVal' in t && (t = t.baseVal),
    t && 'string' == typeof t ? t.split(Z) : []
  ),
  K = 'Capture',
  Q = RegExp(K + '$'),
  X = (t, e, o) => {
    const n = 11 === e.O.nodeType && e.O.host ? e.O.host : e.O,
      i = (t && t.v) || {},
      l = e.v || {};
    for (const t of tt(Object.keys(i))) t in l || G(n, t, i[t], void 0, o, e.u);
    for (const t of tt(Object.keys(l))) G(n, t, i[t], l[t], o, e.u);
  };
function tt(t) {
...
var et = !1,
  ...
  rt = (t, e, o) => {
    ...
    let l,
      ...
      a = 0;
    if (
      (et || ((nt = !0), 'slot' === i.j && (i.u |= i.k ? 2 : 1)), null != i.m)
    )
      l = i.O = p.document.createTextNode(i.m);
    else if (1 & i.u)
      ((l = i.O = p.document.createTextNode('')), X(null, i, it));
    else {
      if (!p.document)
        throw Error(
      ...
      if (
        ((l = i.O = p.document.createElement(!et && 2 & i.u ? 'slot-fb' : i.j)),
        X(null, i, it),
        i.k)
      ) {
        const e = 'template' === i.j ? l.content : l;
        for (a = 0; a < i.k.length; ++a)
          ((s = rt(t, i, a)), s && e.appendChild(s));
      }
    }
    return (
      (l['s-hn'] = B),
  ...
  at = (t) => {
    ...
    if (null != e) {
      ...
      for (const t of o ? n.reverse() : n)
        null != t['s-sh'] &&
          (yt(e, t, null != o ? o : null), (t['s-sh'] = void 0), (nt = !0));
    }
    h.u &= -2;
  },
  ct = (t, e) => {
  ...
  ut = (t, e, o, n, i, l) => {
    ...
    for (
      ...
      n[i] && ((s = rt(null, o, i)), s && ((n[i].O = s), yt(r, s, pt(e))));
  },
  ft = (t, e, o) => {
    for (let n = e; n <= o; ++n) {
      const e = t[n];
  ...
  ht = (t, e, o = !1) => {
    ...
    null == s
      ? ('slot' !== e.j ||
          et ||
          (t.S !== e.S && ((e.O['s-sn'] = e.S || ''), at(e.O.parentElement))),
        X(t, e, it),
        null !== i && null !== l
          ? ((t, e, o, n, i = !1) => {
              let l,
              ...
              for (; r <= f && a <= h; )
                if (null == d) d = e[++r];
                ...
                else if (null == m) m = n[++a];
                else if (null == b) b = n[--h];
                else if (dt(d, m, i)) (ht(d, m, i), (d = e[++r]), (m = n[++a]));
                else if (dt(p, b, i)) (ht(p, b, i), (p = e[--f]), (b = n[--h]));
                else if (dt(d, b, i))
                  (('slot' !== d.j && 'slot' !== b.j) || ct(d.O.parentNode, !1),
                    ht(d, b, i),
                    yt(g, d.O, p.O.nextSibling),
                    (d = e[++r]),
                    (b = n[--h]));
                else if (dt(p, m, i))
                  (('slot' !== d.j && 'slot' !== b.j) || ct(p.O.parentNode, !1),
                    ht(p, m, i),
                    yt(g, p.O, d.O),
                    (p = e[--f]),
                    (m = n[++a]));
                  ...
                  (c >= 0
                    ? ((s = e[c]),
                      s.j !== m.j
                        ? (l = rt(e && e[a], o, c))
                        : (ht(s, m, i), (e[c] = void 0), (l = s.O)),
                      (m = n[++a]))
                    : ((l = rt(e && e[a], o, a)), (m = n[++a])),
                    l && yt(pt(d.O).parentNode, l, pt(d.O)));
                }
              r > f
                ? ut(t, null == n[h + 1] ? null : n[h + 1].O, o, n, a, h)
                : a > h && ft(e, r, f);
            })(n, i, e, l, o)
          : null !== l
            ? (null !== t.m && (n.textContent = ''),
              ut(n, null, e, l, 0, l.length - 1))
            : !o && null !== i && ft(i, 0, i.length - 1))
      : (r = n['s-cr'])
  ...
  gt = (t) => {
    (t.v && t.v.ref && lt.push(() => t.v.ref(null)), t.k && t.k.map(gt));
  },
  vt = (t, e) => {
    st.push(() => t(e));
  },
  ...
  kt = (t, e) => {
    ...
    return (
      e
        ? (t.T && ((t.T = !1), Ct(n, 'connectedCallback', void 0, o)),
          t.L.length && t.L.forEach((t) => t(o)),
          (i = Ct(n, 'componentWillLoad', void 0, o)))
        : (i = Ct(n, 'componentWillUpdate', void 0, o)),
      (i = $t(i, () => Ct(n, 'componentWillRender', void 0, o))),
      $t(i, () => jt(t, n, e))
    );
  },
  $t = (t, e) =>
  ...
  jt = async (t, e, o) => {
              ...
              if ('string' == typeof s) {
                ...
                if ((r || P.set(t, (r = new Set())), !r.has(l))) {
                  ((i = p.document.createElement('style')),
                    (i.textContent = s));
                  const a = null != (o = h.R) ? o : L(p.document);
    ...
    (Ot(t, e, i, o), l && (l.map((t) => t()), (i['s-rc'] = void 0)));
    {
          ...
          if (
            ...
            for (const t of mt) {
              ...
              if (!e['s-ol'] && p.document) {
                ...
                ((t['s-nr'] = e), yt(e.parentNode, (e['s-ol'] = t), e, o));
              }
            }
            for (const t of mt) {
              const e = t.N,
  ...
  zt = (t) => {
    const e = t.$hostElement$,
      o = t.l,
      n = t.F;
    (Ct(o, 'componentDidRender', void 0, e),
      64 & t.u
        ? Ct(o, 'componentDidUpdate', void 0, e)
        : ((t.u |= 64),
          Et(e),
          Ct(o, 'componentDidLoad', void 0, e),
          t.A(e),
          n || Nt()),
      t.D(e),
      t.M && (t.M(), (t.M = void 0)),
  ...
  Nt = () => {
    S(() => q(p, 'appload', { detail: { namespace: 'lido-player' } }));
  },
  Ct = (t, e, o, n) => {
    if (t && t[e])
      try {
  ...
  Et = (t) => t.classList.add('hydrated'),
  Mt = (t, e, o, n) => {
    const i = l(t);
    if (!i) return;
    if (!i)
      throw Error(
        `Couldn't find host element for "${n.h}" as it is unknown to this Stencil runtime. This usually happens when integrating a 3rd party Stencil component with another Stencil component or application. Please reach out to the maintainers of the 3rd party Stencil component or report this on the Stencil Discord server (https://chat.stenciljs.com) or comment on this similar [GitHub issue](https://github.com/stenciljs/core/issues/5457).`,
      );
  ...
  Ft = (t, e, n) => {
    ...
    const r = t.prototype;
    {
      (t.watchers && !e.H && (e.H = I(t.watchers)),
        ...
        ((r.attributeChangedCallback = function (t, n, i) {
          h.jmp(() => {
            ...
            const f = a.find(([t]) => t === c),
              d = f && 4 & f[1][0],
              p = d && null === i && void 0 === this[c];
            d && (i = null !== i && 'false' !== i);
            const h = Object.getOwnPropertyDescriptor(r, c);
            p || i == this[c] || (h.get && !h.set) || (this[c] = i);
          });
        }),
  ...
  Tt = (t, e) => {
    Ct(t, 'connectedCallback', void 0, e);
  },
  Lt = (t, e) => {
    Ct(t, 'disconnectedCallback', void 0, e || t);
  },
  Rt = (t, e = {}) => {
    var o;
    if (!p.document)
    ...
    const n = [],
      ...
      m = p.document.createElement('style'),
      g = [];
    let v,
      y = !0;
    (Object.assign(h, e),
      (h.p = new URL(e.resourcesUrl || './', p.document.baseURI).href));
    let w = !1;
    if (
      (t.map((t) => {
        t[1].map((e) => {
          var o, r;
          const f = { u: e[0], h: e[1], t: e[2], W: e[3] };
          (4 & f.u && (w = !0),
            (f.t = e[2]),
            (f.P = []),
            (f.H = I(e[4])),
                ...
                if (
                  ...
                  if (t.shadowRoot) {
                    if ('open' !== t.shadowRoot.mode)
                      throw Error(
                        `Unable to re-use existing shadow root for ${f.h}! Mode is set to ${t.shadowRoot.mode} but Stencil only supports open shadow roots.`,
                      );
                  } else z.call(t, f);
              }
              connectedCallback() {
                                  ...
                                  try {
                                    if (!(32 & e.u)) {
                                      if (((e.u |= 32), o.q)) {
                                        ...
                                        if (!n)
                                          throw Error(
                                            `Constructor for "${o.h}#${e.G}" was not found`,
                                          );
                                        n.isProxied ||
                                          ((o.H = I(n.watchers)),
                                          (o._ = n.serializers),
          ...
          ((f.q = t[0]),
            i.includes(d) || s.get(d) || (n.push(d), s.define(d, Ft(m, f, 1))));
        });
      }),
      n.length > 0 &&
        (w && (m.textContent += f),
      ...
      const t = null != (o = h.R) ? o : L(p.document);
      (null != t && m.setAttribute('nonce', t),
        r.insertBefore(m, d ? d.nextSibling : r.firstChild));
    }
    ((y = !1),
      g.length
        ? g.map((t) => t.connectedCallback())
        : h.jmp(() => (v = setTimeout(Nt, 30))));
  },
  Bt = (t) => (h.R = t);
export {
  _ as H,
