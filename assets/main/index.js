window.__require = function e(t, n, r) {
  ...
  config: [ function(require, module, exports) {
    ...
    exports.ALL_LANGS = [ Lang.ENGLISH ];
    ...
    var Config = function() {
      ...
      Config.prototype.loadLessonJson = function(callback, node, lessons, maxPerLesson) {
        ...
        if (0 != this.problem) callback(this._lessonData.rows[this.problem - 1]); else if (null != lessons) {
          ...
          lessons.forEach(function(les) {
            var jsonFile = _this.course.id + "/" + (les.orig_lesson_id || les.id) + "/res/" + (les.orig_lesson_id || les.id) + ".json";
          ...
          var jsonFile = this.course.id + "/" + (this.lesson.orig_lesson_id || this.lesson.id) + "/res/" + (this.lesson.orig_lesson_id || this.lesson.id) + ".json";
          util_1.Util.load(jsonFile, function(err, jsonAsset) {
      ...
      Config.prototype.loadSingleCourseJson = function(name, callBack) {
        var _this = this;
        cc.log("loadSingleCourseJson", name);
  ...
  lessonController: [ function(require, module, exports) {
    ...
    var LessonController = function(_super) {
      ...
      LessonController.preloadLesson = function(node, callback) {
        ...
        } else config_1.default.loadBundle(config.lesson.orig_lesson_id || config.lesson.id, function(bundle) {
      ...
      LessonController.preloadAndFirst = function(bundle, callback) {
        bundle.preloadDir("res", null, null, function(err, items) {
          util_1.Util.bundles.set(config_1.default.i.lesson.orig_lesson_id || config_1.default.i.lesson.id, bundle);
      ...
      LessonController.loadQuizzes = function(lessons, callback, node, maxPerLesson) {
        ...
        lessons.forEach(function(les) {
          config_1.default.loadBundle(les.orig_lesson_id || les.id, function(bundle) {
            bundle.preloadDir("res", null, null, function(err, items) {
              util_1.Util.bundles.set(les.orig_lesson_id || les.id, bundle);
              LessonController_1.bundles.push(bundle);
              numLessons--;
            });
          }, callback);
  ...
  profile: [ function(require, module, exports) {
    ...
    var User = function() {
      ...
      User.createUser = function(name, imgPath, age, gender, id, avatarImage, isTeacher) {
        ...
        var user = new User(uid, name, age, gender, imgPath, avatarImage, isTeacher, {}, "camp", "chimp", debug ? new Map([ [ "assignment", new CourseProgressClass() ], [ "en", new CourseProgressClass("en00") ], [ "maths", new CourseProgressClass("maths00") ], [ "puzzle", new CourseProgressClass("puzzle00") ], [ "test-lit", new CourseProgressClass("chapter_0") ], [ "test-maths", new CourseProgressClass("chapter_0") ] ]) : new Map([ [ "assignment", new CourseProgressClass() ], [ "en", new CourseProgressClass() ], [ "maths", new CourseProgressClass() ], [ "puzzle", new CourseProgressClass("puzzle00") ] ]), new Map(), new Map(), {}, {}, debug, [ "", "", "", "", "", "", "", "", "1", "2", "r", "1", "2", "r", "1", "2", "r" ]);
