...
const InfoRow = ({
  ...
  <div
    className="note-details-drawer-info-row"
    id="note-details-drawer-info-row"
  >
    <span
      className="note-details-drawer-info-label"
      id="note-details-drawer-info-label"
    >
      {label}:
    </span>
    <span
      className="note-details-drawer-info-value"
      id="note-details-drawer-info-value"
    >
      {value}
    </span>
  </div>
...
const DetailSection = ({ label, text }: { label: string; text: string }) => (
  <div>
    <div
      className="note-details-drawer-section-title"
      id="note-details-drawer-section-title"
    >
      {label}
    </div>
    <div
      className="note-details-drawer-section-paper"
      id="note-details-drawer-section-paper"
    >
      {text || '--'}
    </div>
  </div>
...
const NoteDetailsDrawer: React.FC<Props> = ({ note, open, onClose }) => {
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className="note-details-drawer-header"
        id="note-details-drawer-header"
      >
        <Typography
          className="note-details-drawer-title"
          id="note-details-drawer-title"
        >
          {t('Note Details')}
        </Typography>
      ...
      <Divider
        className="note-details-drawer-divider"
        id="note-details-drawer-divider"
      />
      ...
      {/* Notes */}
      <div
        className="note-details-drawer-notes-container"
        id="note-details-drawer-notes-container"
      >
      ...
      {/* Media Section */}
      <div
        className="note-details-drawer-media-container"
        id="note-details-drawer-media-container"
      >
        <MediaDisplay
