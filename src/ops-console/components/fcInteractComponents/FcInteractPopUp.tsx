  ...
  return (
    <div className="fc-interact-popup-overlay">
      ...
      >
        ...
        <div className="fc-interact-popup-grid">
          <div className="fc-interact-popup-left-card">
            <div className="fc-interact-popup-left-card-inner">
              <div className="fc-interact-popup-left-top">
                <div>
                  <div className="fc-interact-popup-name">{name}</div>
                  {className && (
                    <div className="fc-interact-popup-class">
                      {t("Class")} {className}
                    </div>
                  )}
                </div>
              ...
              <div className="fc-interact-popup-contact">
                {phone ? (
                  <div
              ...
              <div className="fc-interact-popup-divider" />
              ...
              {mode === "call" && (
                <div className="fc-interact-popup-section">
                  ...
                  >
                    <option value="">{t("Select call outcome")}</option>
              ...
              {/* Spoke With (only if initialUserType is student) */}
              {initialUserType === "student" && (
                <div className="fc-interact-popup-section speak-with-section">
                  <div className="fc-interact-popup-label">
          ...
          <div className="fc-interact-popup-right-area">
            <div className="fc-interact-popup-questions-grid">
              {/* render mandatory first (with badge and red star) */}
              {showMandatory &&
                mandatoryQuestions.map((q, idx) => (
                  <div key={q.id} className="fc-interact-popup-question-row">
                    <div className="fc-interact-popup-question-header">
                      <span className="fc-interact-popup-badge">{idx + 1}</span>
                      <div className="fc-interact-popup-question-text">
                        {q.question}
                        <span className="fc-interact-popup-required">*</span>
                      </div>
                    </div>
                    <textarea
            ...
            <div className="fc-interact-popup-section fc-interact-popup-comments-section">
              <div className="fc-interact-popup-label">
            ...
            {/* Tech issues */}
            {/* Tech issues */}
            <div className="fc-interact-popup-section fc-interact-popup-tech-section">
              <div className="fc-interact-popup-radio-group">
                <label className="fc-interact-popup-radio-item">
                  <input
                    type="radio"
              ...
              {techIssueMarked && (
                <div style={{ marginTop: 8 }}>
                  {/* <div className="fc-interact-popup-label">Add if any tech issues were reported...</div> */}
                  <textarea
                    className="fc-interact-popup-textarea-input"
                    rows={3}
        ...
        {/* Footer */}
        <div className="fc-interact-popup-footer">
          <button className="fc-interact-popup-cancel-btn" onClick={onClose}>
            {t("Cancel")}
          </button>
