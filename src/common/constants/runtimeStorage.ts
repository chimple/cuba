...
export enum EVENTS {
  ...
  BADGE_MILESTONE_REACHED = 'badge_milestone_reached',
  BADGE_POPUP_VIEWED = 'badge_popup_viewed',
  BADGE_POPUP_BUTTON_CLICKED = 'badge_popup_button_clicked',
  BADGE_SHARE_SUCCESS = 'badge_share_success',
  BADGE_SHARE_CANCELLED = 'badge_share_cancelled',
  BADGE_SHARE_FAILED = 'badge_share_failed',
