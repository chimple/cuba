...
export enum SORTED_GRADES{
  BELOWGRADE1 = "NIAdGIaaRXi8BOl87MEu",
  GRADE1 = "R5sDh8LKKBx7D7o1MMl0",
  GRADE2 = "al0OqObeTBK3OFWSyDOg",
  GRADE3 = "i1paELqh4uwET2OQQl1E",
  ABOVEGRADE3 = "rhuiXCmMzmJM1dkN8UNu",
}

export const GRADES_ORDER = {
  [SORTED_GRADES.BELOWGRADE1]: 1,
  [SORTED_GRADES.GRADE1]: 2,
  [SORTED_GRADES.GRADE2]: 3,
  [SORTED_GRADES.GRADE3]: 4,
  [SORTED_GRADES.ABOVEGRADE3]: 5,
};
