      ...
      <IonCard
        ...
        onClick={async () => {
          if (isUnlocked) {
            ...
            if (lesson.plugin_type === LIDO || lesson.plugin_type === LIDO_ASSESSMENT) {
              const lidoLessonId = lesson.cocos_lesson_id;
          ...
          >
            ...
            <div className="pattern">
              <SelectIconImage
                ...
                defaultSrc={'courses/sl_en1_mp/icons/ChallengePattern.png'}
                webSrc={
