...
describe("SelectChapter", () => {
  ...
  it("renders long chapter name text inside chapter label area", () => {
    ...
    expect(chapterLabel.closest(".chapter-icon-and-chapter-download-container")).toBeTruthy();
  });

  it("keeps chapter layout and text overflow contracts", () => {
    const css = fs.readFileSync(
      path.join(process.cwd(), "src/components/displaySubjects/SelectChapter.css"),
      "utf8"
    );
