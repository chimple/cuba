...
describe('TressureBox', () => {
  ...
  test('renders static box when start and end are equal', () => {
    ...
    expect(
      screen.queryByAltText('Confetti Treasure Box'),
  ...
  test('hides scroll container after animation completion', () => {
    ...
    expect(container.querySelector('.number-inside-box')).toHaveTextContent(
      '4',
    );
  });
  ...
  ])('reaches final value from $start to $end', ({ start, end, expected }) => {
  ...
  test('rerendering to a new animated range restarts update UI', () => {
    const { rerender, container } = render(
      <TressureBox startNumber={1} endNumber={1} />,
    );
    expect(
      container.querySelector('.scroll-container'),
    ).not.toBeInTheDocument();
  ...
  test('highlights a current number item during update', () => {
    ...
    expect(
      container.querySelector('.scroll-item.highlight'),
    ).toBeInTheDocument();
  });
  ...
  test('renders treasure wrapper container structure', () => {
    ...
    expect(
      container.querySelector('.treasure-box-container'),
    ).toBeInTheDocument();
    expect(
      container.querySelector('.treasure-box-wrapper'),
    ).toBeInTheDocument();
  });
