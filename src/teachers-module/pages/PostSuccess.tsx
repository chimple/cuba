          ...
          <a href="https://www.bit.ly/chimple-help-line" target="_blank" style={{ textDecoration: "none" }}>
            <div className="post-success-create-school-whatsapp-support">
              ...
              <div className="post-success-create-school-whatsapp-support-text">
                <p>{t("Chat with us on ")}</p><p className="post-success-span-text-whatsapp">{t("WhatsApp")}</p>
              </div>
            </div>
          </a>
          <div className="post-success-create-school-youtube-div">
            <iframe src="https://www.youtube.com/embed/G_OW3hNtZ3o?si=U5jhUwks05doZ_2R" width={"70%"} height={"315px"} title="YouTube video player" allowFullScreen className="post-success-create-school-youtube-video"></iframe>
            ...
            >
              <div className="post-success-card-content">
                ...
                <div className="post-success-create-school-card-content-div">
                  <img className="post-success-card-content-img" src="assets/icons/switchToKidsMode.png" alt="" />
                  <p className="post-success-create-school-img-footer">{t("Gamified Learning")}</p>
                </div>
              </div>
            </div>
          </a>
